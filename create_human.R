...
names(gii) <- c("giiRank", "coutry", "gii", "mMortalityRatio", "adolescentBirthRate", "%repInParliament", "withSecondaryEduF", "withSecondaryEduM", "labourParticipRateF", "labourParticipRateM")
...
human <- dplyr::inner_join(hd, gii, by = hd$country)
